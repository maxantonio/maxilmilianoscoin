...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: maxcoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 87322 or testnet: 187322)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 87321 or testnet: 187321)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Maxcoin Wiki for SSL setup instructions)") + "\n" +
