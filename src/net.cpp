...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Maxcoin " + FormatFullVersion();
...
// Seri ancesario ajustar
static const char *strMainNetDNSSeed[][2] = {
    {"maxcointools.com", "dnsseed.maxcointools.com"},
    {"maxcoinpool.org", "dnsseed.maxcoinpool.org"},
    {"xurious.com", "dnsseed.MXC.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"maxcointools.com", "testnet-seed.maxcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Maxcoin is probably already running."), addrBind.ToString().c_str());
        else
